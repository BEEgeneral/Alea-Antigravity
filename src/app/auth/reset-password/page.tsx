    ...
    const handleSubmitCode = async (e: React.FormEvent) => {
        ...
        try {
            const res = await fetch('/api/auth/reset-password', {
                ...
                body: JSON.stringify({
                    otp: formData.code,
                    newPassword: formData.newPassword || 'temporary'
                })
            });
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        name="email"
                                        required
                                        className="w-full bg-muted/30 border border-border rounded-2xl py-4 px-6 text-sm focus:outline-none focus:border-primary/50 focus:bg-muted/50 transition-all font-medium"
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        required
                                        maxLength={6}
                                        className="w-full bg-muted/30 border border-border rounded-2xl py-4 px-6 text-sm focus:outline-none focus:border-primary/50 focus:bg-muted/50 transition-all font-medium text-center tracking-[0.5em]"
                                        placeholder="123456"
                                        value={formData.code}
                                        onChange={handleChange}
                                    />
...
function LoadingFallback() {
    return (
        <main className="min-h-screen bg-background text-foreground selection:bg-primary/30 font-sans flex items-center justify-center">

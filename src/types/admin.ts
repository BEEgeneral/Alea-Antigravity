// ─────────────────────────────────────────────────────────
// Alea Signature — Admin Domain Types
...
export interface Investor {
  ...
  piedra?: import('./index').piedraPreciosa;
  disc?: import('./index').DISCType;
  risk_profile?: import('./index').RiskProfile;
}
...
export interface Lead {
  ...
  investors?: Investor;
  properties?: Property;
  source?: import('./index').LeadSource;
  intermediaries?: Collaborator[];
  nda_signed?: boolean;
}
...
export interface Signal {
  id: string;
  source: import('./index').SignalSource;
  asset_type: string;
  location_hint: string;
  alea_score: number;
  score_classification: AleaScoreClassification;
  status: import('./index').SignalStatus;
  detected_at: string;
  updated_at?: string;
  metadata?: Record<string, unknown>;
}
